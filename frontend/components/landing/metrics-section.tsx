...
const metrics = [
  {
    ...
    suffix: "",
    prefix: "",
    label: "AI agents in the pipeline",
  },
  {
    value: 4,
    suffix: "",
  ...
  },
  {
    ...
    suffix: "",
    prefix: "",
    label: "Max reflection passes per draft",
  },
  {
    value: 85,
    suffix: " / 100",
...
export function MetricsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-16 sm:py-20 lg:py-32 border-y border-foreground/10">

        ...
        <div className="relative min-h-screen flex items-center justify-center px-6 py-12 noise-overlay">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="border border-foreground/10 p-8 lg:p-10">
                    <h1 className="text-3xl font-display tracking-tight text-center mb-2">Create an account</h1>
                    <p className="text-sm text-muted-foreground text-center mb-8">
                        Start turning stakeholder text into a real spec
                    </p>

                    <form onSubmit={handleSignup} className="space-y-5">
                        <div className="space-y-2">
                            <Label htmlFor="fullname" className="font-mono text-xs uppercase tracking-wide text-muted-foreground">Full name</Label>
                            <Input
                                id="fullname"
                                type="text"
                ...
                <p className="text-center text-sm text-muted-foreground mt-6">
                    ...
                    <Link href="/auth/login" className="text-foreground hover:underline underline-offset-4 font-medium">
                        Sign in
                    </Link>
                </p>
            </div>

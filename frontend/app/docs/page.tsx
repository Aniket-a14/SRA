...
export default function DocsOverviewPage() {
    return (
        <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 sm:py-16 space-y-16">
            {/* Hero Section */}
            ...
            <div className="border border-foreground/10 bg-background p-6 sm:p-8 space-y-6">
            ...
            <div className="border border-foreground/10 bg-background p-6 sm:p-8 space-y-4">

...
export default async function DocsSlugPage({ params }: DocsSlugPageProps) {
    ...
    return (
        <div className="flex min-h-full">
            ...
            <div className="flex-1 min-w-0 max-w-4xl px-6 sm:px-10 py-10 sm:py-14 space-y-12">
                {/* Header */}
            ...
            {/* Right-Hand Structure & Inspector Sidebar (Sticky Desktop Rail) */}
            <div className="hidden lg:block w-72 shrink-0 border-l border-foreground/10">
                <div className="sticky top-13 max-h-[calc(100vh-3.25rem)] overflow-hidden">
                    <DocsRightSidebar category={category} className="h-full border-l-0" />
                </div>
            </div>
        </div>
    )
